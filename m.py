...
BOT_TOKEN = "7636222944:AAG_-6CbBy8dBNnvv1d0yjQwTX19WSRNYmM"
API_ID = "25579552"
...
async def careerdl(app, message, headers, raw_text2, raw_text3, prog, name, name1):
    ...
    if video_links:
        ...
        await app.send_document(message.chat.id, document=video_filename, caption=f"**--This file contains Notes links --\n\nApp Name: Careerwill\nBatch Name: `{name}`**\n\nBy: <a href='https://t.me/AJ_PYTHON_15'>𝗔𝗝 𝗣𝗬𝗧𝗛𝗢𝗡 ㊝</a>")
